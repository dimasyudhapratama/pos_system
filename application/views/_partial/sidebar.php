...
<head>
    ...
    <title>Static Table | Kiaalap - Kiaalap Admin Template</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="<?php echo base_url() ?>index.php/Test/Education"><span class="mini-sub-pro">Dashboard v.1</span></a></li>
                                <li><a title="Dashboard v.2" href="<?php echo base_url() ?>index.php/Test/Education2"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="Dashboard v.3" href="<?php echo base_url() ?>index.php/Test/Education3"><span class="mini-sub-pro">Dashboard v.3</span></a></li>
