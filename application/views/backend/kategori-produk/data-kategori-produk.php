                                    ...
                                    <td style="text-align:center">
                                        <div class="btn-group btn-sm">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <!-- <li><a class="click-edit" href="#" id="<?php echo $c->id_kategori_produk; ?>">Edit</a></li> -->
                                                <li><a onclick="edit(<?php echo $c->id_kategori_produk; ?>)" data-toggle="modal" href="#">Edit</a></li>
                                                <li><a onclick="return confirm('Anda Yakin Ingin Menghapus Data?')" href="<?php echo base_url().'index.php/kategori_produk/delete/'.$c->id_kategori_produk; ?>">Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div id="modaladd" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo base_url()."index.php/kategori_produk/add" ?>" method="post">
